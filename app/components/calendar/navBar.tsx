...
export const WeekNavigation = ({
  ...
  return (
    <div className="col-start-2 grid grid-rows-[100%] grid-cols-[auto] place-items-center gap-[4px] w-[100%] h-[90%] text-sm px-2 border-primary-300 border-[2px] bg-primary-50 rounded-xl">
      <button
        onClick={() => {
